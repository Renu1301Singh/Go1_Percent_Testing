module.exports = {
    ...
    clickCrouselButton(){
        return this
        .waitForElementVisible('@CarouselSlider',2000)
    },

    clickMicrosoftLogo(){
        return this
        .waitForElementVisible('@MicrosoftLogo',2000)
        .click('@MicrosoftLogo')
    },
    ...
    ClickForgotPassword(){
        return this
        .waitForElementVisible('@ForgotPassword', 2000)
    ...
    clickTermsOfUse(){
        return this
        .waitForElementVisible('@TermsOfUse',2000)
        .click('@TermsOfUse')
    },

    ClickPrivacyPolicy(){
        return this
        .waitForElementVisible('@PrivacyPolicy',2000)
        .click('@PrivacyPolicy')
    }
